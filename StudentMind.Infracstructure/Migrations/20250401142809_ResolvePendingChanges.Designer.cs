...
namespace StudentMind.Infracstructure.Migrations
{
    ...
    [Migration("20250401142809_ResolvePendingChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentMind.Core.Entity.HealthScoreRule", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StudentMind.Core.Entity.StudentHealth", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StudentMind.Core.Entity.StudentHealth", b =>
                {
                    b.HasOne("StudentMind.Core.Entity.User", "Student")
                        .WithMany("StudentHealths")
            ...
            modelBuilder.Entity("StudentMind.Core.Entity.SurveyResponse", b =>
                {
                    b.HasOne("StudentMind.Core.Entity.Choice", "Choice")
            ...
            modelBuilder.Entity("StudentMind.Core.Entity.Survey", b =>
                {
                    b.Navigation("HealthScoreRules");

                    b.Navigation("StudentHealths");
